...
namespace EquipmentReturn.Automation.FunctionalTest
{
    ...
    class TC001_VerifyAllFieldsEmpty : TestEngine
    {
        [TearDown]
        ...
        [TestCase("android", TestName = "TC001_VerifyAllFieldsEmpty")]
        public void TC001_VerifyingAllFieldsEmpty(string strmobiledevice)
        {

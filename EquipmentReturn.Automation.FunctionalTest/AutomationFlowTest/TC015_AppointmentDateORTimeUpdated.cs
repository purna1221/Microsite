...
namespace EquipmentReturn.Automation.FunctionalTest.AutomationFlowTest
{
    ...
    class TC015_AppointmentDateORTimeUpdated :TestEngine
    {
        [TearDown]
        ...
        [TestCase("android", TestName = "TC015_AppointmentDateORTimeUpdated")]
        public void TC015_VerifyAppointmentDateORTimeUpdated(string strmobiledevice)
        {
            ...
            DataTable AddReturnInPerson = ExcelReader.ReadExcelFile("EquipmentReturn", "AppointmentDateTimeUpdated", true);
